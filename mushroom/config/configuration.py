from mushroom.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,\
    ModelTrainingConfig,ModelEvaluationConfig,ModelPusherConfig,TrainingPipelineConfig
from mushroom.utils.util import read_yaml_file
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            data_ingestion_artifact_dir = os.path.join(
                artifact_dir,
                DATA_INGESTION_ARTFICAT_DIR_KEY,
                self.time_stamp)
